...
<div>
    <table width="400px;"height="510px" border="1px" bordercolor="white" bgcolor="lightblue">
        ...
        <%
            List<StudentInfo> seeOneStudentInfos = (List<StudentInfo>) request.getSession().getAttribute("seeOneStudentInfos");
        %>
        <tr>
        ...
        <c:forEach items="${sessionScope.seeOneStudentInfos}" var="oneStudentInfo">
        <tr>
            <td align="center" width="200px" height="30px">${oneStudentInfo.getTitle()}</td>
            <td align="center" width="200px" height="30px">${oneStudentInfo.getScore()}</td>
        </tr>
        </c:forEach>
        <tr>
            <td align="center" width="200px" height="30px"><a href="change/${sessionScope.seeOneStudentInfos.get(0).getStudentId()}"><button class="button">修改</button></a>
            <td align="center" width="200px" height="30px"><input type="button" class="button" value="保存"></td>
        </tr>
    </table>
</div>
</body>
